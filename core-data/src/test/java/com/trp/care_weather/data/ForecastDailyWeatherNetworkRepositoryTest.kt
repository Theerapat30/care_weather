...
class ForecastDailyWeatherNetworkRepositoryTest {

    private var lat: Double = 0.00
    private var lon: Double = 0.00

    private lateinit var repo: ForecastWeatherNetworkRepository
    ...
    fun setupNetwork(){
        ...
        repo = ForecastWeatherNetworkRepository(openWeatherApi)
    }

    @Test
    fun getWeathers_inputCorrect_shouldReturnData() = runTest {
        val result = repo.getWeathers(latitude = lat, longitude = lon)
